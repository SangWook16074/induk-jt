...
import 'package:flutter_main_page/ui/mainPage/com_noticeWrite.dart';
...
class Notice {
  ...
  Notice(this.title, this.author, this.content, this.time);
}

class NoticeManagePage extends StatefulWidget {
  const NoticeManagePage({Key? key}) : super(key: key);
        ...
        onPressed: () {
          Navigator.push(
              ...
              (Platform.isAndroid)
                  ...
                  : CupertinoPageRoute(builder: (context) => WriteNotice()));
        },
      ),
